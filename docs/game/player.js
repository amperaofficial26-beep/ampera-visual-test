...
export class Player {
  ...
  update(dt,keys,camera){
    ...
    this.group.position.x=THREE.MathUtils.clamp(this.group.position.x,-27,27);this.group.position.z=THREE.MathUtils.clamp(this.group.position.z,-25,12);this.group.position.y=terrainHeight(this.group.position.x,this.group.position.z)+.05;
  }
}
